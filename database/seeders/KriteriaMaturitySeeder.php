...
use App\Models\KriteriaMaturity;
use Illuminate\Database\Seeder;

class KriteriaMaturitySeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $work_product = [
            ...
            null, null, null, null, null, null, null, null, null, null,
            null, null, null, null, null, null, null, null, null, null,
            null, null, null, null, null, null, null, null, null, null, 'Tidak ada work product, setidaknya pengelolaan SDM baru terbatas pada kegiatan personalia dan administrasi seperti namun tidak terbatas kepada penggajian/remunerasi, pengelolaan data SDM, dan lain-lain.', 'Tidak ada work product, setidaknya tugas dan peran SDM (misal job description) jika ada belum tertuang dalam dokumen resmi organisasi.', 'Tidak ada work product, setidaknya pelatihan belum pernah diberikan atau
        ...
        foreach ($kode_indikator_id as $index => $value) {
            KriteriaMaturity::create([
                'kode_kriteria' => $value,
                'kode_indikator_id' => explode('.', $kode_indikator_id[$index])[0] . '.' . explode('.', $kode_indikator_id[$index])[1],
                'maturity_level' => trim($maturity_level[$index]),
                'kriteria_indikator' => trim($kriteria_indikator[$index]),
                'work_product' => trim($work_product[$index])
            ]);
        }
    }
}
