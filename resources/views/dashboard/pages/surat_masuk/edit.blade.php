                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title">Formulir Edit Surat Masuk</h2>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-edit">
                                    <form action="{{ url('surat_masuk/' . $data->id) }}" method="POST"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-12 col-md-8">
                                                ...
                                                <input type="hidden" name="old_file_surat" value="{{ $data->file_surat }}">
                                                @error('file_surat')
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-12 col-md-8">
                                                <input type="text"
                                                    ...
                                                    required autofocus value="{{ $data->no_surat }}">
                                                @error('no_surat')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="form-text text-muted"><span class="text-danger">*</span> Wajib
                                            Diisikan!
                                        </div>
