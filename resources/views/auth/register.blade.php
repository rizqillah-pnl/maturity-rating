            ...
            <div
                ...
                <div class="max-w-md w-full justify-center">
                    ...
                    <div class="text-center">
                        ...
                        <p class="mt-2 text-sm text-gray-500">Please type your new account!</p>
                    </div>

                    <form action="{{ url('/register') }}" method="POST" autocomplete="off" autocapitalize="off">
                        @csrf
                        ...
                        <div class="relative">
                            <label class="ml-3 text-sm font-bold text-gray-700 tracking-wide"
                                for="nama">Nama</label>
                            <input
                                class=" w-full text-base px-4 py-2 border-b border-gray-300 focus:outline-none rounded-2xl focus:border-indigo-500 @error('nama') {{ $err }} @enderror"
                                type="text" placeholder="Masukkan Nama" id="nama" name="nama" required
                                value="{{ old('nama') }}"
                        ...
                        <div class="mt-4 content-center">
                            ...
                            <input
                                ...
                                type="text" placeholder="Masukkan Username" id="username" name="username" required
                                value="{{ old('username') }}"
                        ...
                        <div class="mt-4 content-center">
                            ...
                            <input
                                ...
                                type="password" placeholder="Masukkan Password" id="password" name="password" required>
                        </div>
                        <div class="flex items-center justify-between mt-3">
                            ...
                            <div class="flex items-center">
                                <p class="register-btn">Sudah Punya Akun? <a href="{{ url('login') }}"
                                        class="btn-link">Login</a>
                                </p>
                            </div>
                        </div>
                        <div class="mt-4">
